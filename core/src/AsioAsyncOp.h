...
struct AsioAsyncOpImpl : AsioAsyncOpImplBase<SignatureArgTypes...>
{
    ...
    auto GetAlloc2() const -> Allocator2 { return boost::asio::get_associated_allocator(fHandler, fAlloc1); }
    auto GetEx2() const -> Executor2 { return boost::asio::get_associated_executor(fWork2); }
