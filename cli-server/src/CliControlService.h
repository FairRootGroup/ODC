        ...
        class CCliControlService : public odc::core::CCliServiceHelper<CCliControlService>
        {
          public:
            ...
            std::string requestConfigure(const odc::core::partitionID_t& _partitionID,
                                         const odc::core::SDeviceParams& _params);
            std::string requestStart(const odc::core::partitionID_t& _partitionID,
                                     const odc::core::SDeviceParams& _params);
            std::string requestStop(const odc::core::partitionID_t& _partitionID,
                                    const odc::core::SDeviceParams& _params);
            std::string requestReset(const odc::core::partitionID_t& _partitionID,
                                     const odc::core::SDeviceParams& _params);
