...
class SyncController final : public odc::ODC::Service
{
  public:
    ...
    void registerResourcePlugins(const odc::core::PluginManager::PluginMap& pluginMap) { mCtrl.registerResourcePlugins(pluginMap); }
    void registerRequestTriggers(const odc::core::PluginManager::PluginMap& triggerMap) { mCtrl.registerRequestTriggers(triggerMap); }
