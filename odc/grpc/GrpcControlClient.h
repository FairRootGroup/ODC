...
class CGrpcControlClient : public odc::core::CCliServiceHelper<CGrpcControlClient>
{
  public:
    ...
    std::string requestInitialize(const odc::core::CommonParams& _common, const odc::core::SInitializeParams& _params);
  ...
  private:
    std::string updateRequest(const odc::core::CommonParams& _common, const odc::core::SUpdateParams& _params);
    template <typename Request_t, typename StubFunc_t>
    std::string stateChangeRequest(const odc::core::CommonParams& _common,
  ...
  private:
    ...
    void updateCommonParams(const odc::core::CommonParams& _common, Request_t* _request);
