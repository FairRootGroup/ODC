...
struct ChangeState : Cmd
{
    ...
    fair::mq::Transition GetTransition() const { return fTransition; }
    void SetTransition(fair::mq::Transition transition) { fTransition = transition; }
...
struct TransitionStatus : Cmd
{
    ...
    fair::mq::Transition GetTransition() const { return fTransition; }
    void SetTransition(const fair::mq::Transition transition) { fTransition = transition; }
    fair::mq::State GetCurrentState() const { return fCurrentState; }
    void SetCurrentState(fair::mq::State state) { fCurrentState = state; }
